...
typedef struct _fk_app_SelfCheck {
    pb_callback_t key;
    uint32_t status;
} fk_app_SelfCheck;

typedef struct _fk_app_HardwareStatus {
    pb_callback_t self_checks;
...
#define fk_app_WireMessageQuery_type_ENUMTYPE fk_app_QueryType


#define fk_app_WireMessageReply_type_ENUMTYPE fk_app_ReplyType
...
#define fk_app_HttpQuery_type_ENUMTYPE fk_app_QueryType
...
#define fk_app_HttpReply_type_ENUMTYPE fk_app_ReplyType

#define fk_app_ModuleHttpQuery_type_ENUMTYPE fk_app_ModuleQueryType

#define fk_app_ModuleHttpReply_type_ENUMTYPE fk_app_ModuleReplyType

#define fk_app_UdpMessage_status_ENUMTYPE fk_app_UdpStatus
...
#define fk_app_NetworkSettings_init_default      {0, {{NULL}, NULL}, false, fk_app_NetworkInfo_init_default, {{NULL}, NULL}, 0, 0}
...
#define fk_app_SelfCheck_init_default            {{{NULL}, NULL}, 0}
#define fk_app_HardwareStatus_init_default       {{{NULL}, NULL}}
...
#define fk_app_LoraSettings_init_default         {0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define fk_app_UdpMessage_init_default           {{{NULL}, NULL}, _fk_app_UdpStatus_MIN, 0, 0}
...
#define fk_app_NetworkSettings_init_zero         {0, {{NULL}, NULL}, false, fk_app_NetworkInfo_init_zero, {{NULL}, NULL}, 0, 0}
...
#define fk_app_SelfCheck_init_zero               {{{NULL}, NULL}, 0}
#define fk_app_HardwareStatus_init_zero          {{{NULL}, NULL}}
...
#define fk_app_LoraSettings_init_zero            {0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define fk_app_UdpMessage_init_zero              {{{NULL}, NULL}, _fk_app_UdpStatus_MIN, 0, 0}
...
#define fk_app_NetworkSettings_supportsUdp_tag   6
...
#define fk_app_SelfCheck_key_tag                 1
#define fk_app_SelfCheck_status_tag              2
#define fk_app_HardwareStatus_self_checks_tag    1
...
#define fk_app_LoraSettings_verify_tag           11
...
#define fk_app_HttpReply_events_tag              13
...
#define fk_app_UdpMessage_port_tag               4
...
X(a, STATIC,   SINGULAR, BOOL,     supportsUdp,       6)
...
#define fk_app_SelfCheck_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   key,               1) \
X(a, STATIC,   SINGULAR, UINT32,   status,            2)
#define fk_app_SelfCheck_CALLBACK pb_default_field_callback
#define fk_app_SelfCheck_DEFAULT NULL

#define fk_app_HardwareStatus_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  self_checks,       1)
#define fk_app_HardwareStatus_CALLBACK pb_default_field_callback
#define fk_app_HardwareStatus_DEFAULT NULL
#define fk_app_HardwareStatus_self_checks_MSGTYPE fk_app_SelfCheck
...
X(a, STATIC,   SINGULAR, BOOL,     verify,           11)
...
X(a, CALLBACK, SINGULAR, BYTES,    events,           13)
...
extern const pb_msgdesc_t fk_app_SelfCheck_msg;
...
#define fk_app_SelfCheck_fields &fk_app_SelfCheck_msg
...
/* fk_app_SelfCheck_size depends on runtime parameters */
/* fk_app_HardwareStatus_size depends on runtime parameters */
