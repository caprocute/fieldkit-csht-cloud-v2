...
(function(global, factory) { /* global define, require, module */
    ...
    $root.fk_app = (function() {
        ...
        fk_app.SelfCheck = (function() {
    
            /**
             * Properties of a SelfCheck.
             * @memberof fk_app
             * @interface ISelfCheck
             * @property {string} [key] SelfCheck key
             * @property {number} [status] SelfCheck status
             */
             ...
             * @constructor
             * @param {fk_app.ISelfCheck=} [properties] Properties to set
             */
             ...
             * SelfCheck key.
             * @member {string}key
             * @memberof fk_app.SelfCheck
             * @instance
             */
            SelfCheck.prototype.key = "";
             ...
             * @static
             * @param {fk_app.ISelfCheck=} [properties] Properties to set
             * @returns {fk_app.SelfCheck} SelfCheck instance
             */
            ...
            /**
             * Encodes the specified SelfCheck message. Does not implicitly {@link fk_app.SelfCheck.verify|verify} messages.
             * @function encode
             * @memberof fk_app.SelfCheck
             * @static
             * @param {fk_app.ISelfCheck} message SelfCheck message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified SelfCheck message, length delimited. Does not implicitly {@link fk_app.SelfCheck.verify|verify} messages.
             * @function encodeDelimited
             * @memberof fk_app.SelfCheck
             * @static
             * @param {fk_app.ISelfCheck} message SelfCheck message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {fk_app.SelfCheck} SelfCheck
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SelfCheck.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.fk_app.SelfCheck();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            SelfCheck.fromObject = function fromObject(object) {
                if (object instanceof $root.fk_app.SelfCheck)
                    return object;
                var message = new $root.fk_app.SelfCheck();
                if (object.key != null)
             ...
             * @memberof fk_app.SelfCheck
             * @static
             * @param {fk_app.SelfCheck} message SelfCheck
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            SelfCheck.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults) {
        ...
        fk_app.HardwareStatus = (function() {
             ...
             * @property {Array.<fk_app.ISelfCheck>} [selfChecks] HardwareStatus selfChecks
             */
            ...
            /**
             * HardwareStatus selfChecks.
             * @member {Array.<fk_app.ISelfCheck>}selfChecks
             * @memberof fk_app.HardwareStatus
             * @instance
             */
            HardwareStatus.prototype.selfChecks = $util.emptyArray;
            ...
            HardwareStatus.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.selfChecks != null && message.selfChecks.length)
                    for (var i = 0; i < message.selfChecks.length; ++i)
                        $root.fk_app.SelfCheck.encode(message.selfChecks[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            HardwareStatus.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    switch (tag >>> 3) {
                    case 1:
                        if (!(message.selfChecks && message.selfChecks.length))
                            message.selfChecks = [];
                        message.selfChecks.push($root.fk_app.SelfCheck.decode(reader, reader.uint32()));
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            HardwareStatus.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.selfChecks != null && message.hasOwnProperty("selfChecks")) {
                    if (!Array.isArray(message.selfChecks))
                        return "selfChecks: array expected";
                    for (var i = 0; i < message.selfChecks.length; ++i) {
                        var error = $root.fk_app.SelfCheck.verify(message.selfChecks[i]);
                        if (error)
                            return "selfChecks." + error;
                    }
                }
                return null;
            };
            ...
            HardwareStatus.fromObject = function fromObject(object) {
                if (object instanceof $root.fk_app.HardwareStatus)
                    return object;
                var message = new $root.fk_app.HardwareStatus();
                if (object.selfChecks) {
                    if (!Array.isArray(object.selfChecks))
                        throw TypeError(".fk_app.HardwareStatus.selfChecks: array expected");
                    message.selfChecks = [];
                    for (var i = 0; i < object.selfChecks.length; ++i) {
                        if (typeof object.selfChecks[i] !== "object")
                            throw TypeError(".fk_app.HardwareStatus.selfChecks: object expected");
                        message.selfChecks[i] = $root.fk_app.SelfCheck.fromObject(object.selfChecks[i]);
                    }
                }
                return message;
            };
             ...
             * @returns {Object.<string,*>} Plain object
             */
            HardwareStatus.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.arrays || options.defaults)
                ...
                if (message.selfChecks && message.selfChecks.length) {
                    object.selfChecks = [];
                    for (var j = 0; j < message.selfChecks.length; ++j)
                        object.selfChecks[j] = $root.fk_app.SelfCheck.toObject(message.selfChecks[j], options);
                }
                return object;
            };
        ...
        fk_app.LoraSettings = (function() {
             ...
             * @property {boolean} [verify] LoraSettings verify
             ...
             * @instance
             */
            LoraSettings.prototype.verify = false;
            ...
            LoraSettings.encode = function encode(message, writer) {
                ...
                if (message.verify != null && message.hasOwnProperty("verify"))
                    writer.uint32(/* id 11, wireType 0 =*/88).bool(message.verify);
                return writer;
            };
        ...
        fk_app.HttpReply = (function() {
             ...
             * @property {Uint8Array} [events] HttpReply events
             */
             ...
             * @instance
             */
            HttpReply.prototype.events = $util.newBuffer([]);
            ...
            HttpReply.encode = function encode(message, writer) {
                ...
                if (message.events != null && message.hasOwnProperty("events"))
                    writer.uint32(/* id 13, wireType 2 =*/106).bytes(message.events);
                return writer;
            };
            ...
            HttpReply.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.events = options.bytes === String ? "" : [];
                }
                if (message.type != null && message.hasOwnProperty("type"))
                    object.type = options.enums === String ? $root.fk_app.ReplyType[message.type] : message.type;
                if (message.errors && message.errors.length) {
