...
class QueryFlags extends $pb.ProtobufEnum {
  ...
  static final $core.List<QueryFlags?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static QueryFlags? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const QueryFlags._(super.v, super.n);
}
...
class QueryType extends $pb.ProtobufEnum {
  ...
  static final $core.List<QueryType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 28);
  static QueryType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const QueryType._(super.v, super.n);
}
...
class ReplyType extends $pb.ProtobufEnum {
  ...
  static final $core.List<ReplyType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 19);
  static ReplyType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ReplyType._(super.v, super.n);
}
...
class DownloadFlags extends $pb.ProtobufEnum {
  ...
  static final $core.List<DownloadFlags?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static DownloadFlags? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const DownloadFlags._(super.v, super.n);
}
...
class ModuleFlags extends $pb.ProtobufEnum {
  ...
  static final $core.List<ModuleFlags?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static ModuleFlags? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ModuleFlags._(super.v, super.n);
}
...
class SensorFlags extends $pb.ProtobufEnum {
  ...
  static final $core.List<SensorFlags?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 0);
  static SensorFlags? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const SensorFlags._(super.v, super.n);
}
...
class ModuleQueryType extends $pb.ProtobufEnum {
  ...
  static final $core.List<ModuleQueryType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ModuleQueryType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ModuleQueryType._(super.v, super.n);
}
...
class ModuleReplyType extends $pb.ProtobufEnum {
  ...
  static final $core.List<ModuleReplyType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ModuleReplyType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ModuleReplyType._(super.v, super.n);
}
...
class UdpStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<UdpStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static UdpStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const UdpStatus._(super.v, super.n);
}
