...
class QueryCapabilities extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearCallerTime() => $_clearField(2);
}
...
class LiveValue extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  void clearUncalibrated() => $_clearField(3);
}
...
class SensorCapabilities extends $pb.GeneratedMessage {
  factory SensorCapabilities({
    ...
    if (uncalibratedUnitOfMeasure != null) {
      $result.uncalibratedUnitOfMeasure = uncalibratedUnitOfMeasure;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(5)
  void clearUnitOfMeasure() => $_clearField(5);
  ...
  @$pb.TagNumber(8)
  set value(LiveValue v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  void clearUncalibratedUnitOfMeasure() => $_clearField(9);
}
...
class ModuleCapabilities extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $pb.PbList<SensorCapabilities> get sensors => $_getList(2);
  ...
  @$pb.TagNumber(7)
  set header(ModuleHeader v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class Capabilities extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $pb.PbList<ModuleCapabilities> get modules => $_getList(3);

  @$pb.TagNumber(5)
  $pb.PbList<SensorCapabilities> get sensors => $_getList(4);
}
...
class NetworkInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearPreferred() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearKeeping() => $_clearField(5);
}
...
class NetworkSettings extends $pb.GeneratedMessage {
  factory NetworkSettings({
    ...
    $core.bool? modifying,
    $core.bool? supportsUdp,
  }) {
    final $result = create();
    if (createAccessPoint != null) {
      $result.createAccessPoint = createAccessPoint;
    }
    if (networks != null) {
    ...
    if (modifying != null) {
      $result.modifying = modifying;
    }
    if (supportsUdp != null) {
      $result.supportsUdp = supportsUdp;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(1)
  void clearCreateAccessPoint() => $_clearField(1);

  @$pb.TagNumber(2)
  $pb.PbList<NetworkInfo> get networks => $_getList(1);

  @$pb.TagNumber(3)
  NetworkInfo get connected => $_getN(2);
  @$pb.TagNumber(3)
  set connected(NetworkInfo v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  void clearMacAddress() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearModifying() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  void clearSupportsUdp() => $_clearField(6);
}
...
class Firmware extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  void clearLogicalAddress() => $_clearField(6);
...
class Identity extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearFirmware() => $_clearField(4);
  ...
  @$pb.TagNumber(7)
  void clearGenerationId() => $_clearField(7);
...
class LiveData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $pb.PbList<LiveDataSample> get samples => $_getList(0);
}
...
class File extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  void clearMaximum() => $_clearField(6);
}
...
class DeviceStatus extends $pb.GeneratedMessage {
  factory DeviceStatus({
    ...
    if (gpsHasFix != null) {
      $result.gpsHasFix = gpsHasFix;
    }
    if (gpsSatellites != null) {
      $result.gpsSatellites = gpsSatellites;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(2)
  void clearBatteryPercentage() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearBatteryVoltage() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearGpsHasFix() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearGpsSatellites() => $_clearField(5);
}
...
class WireMessageQuery extends $pb.GeneratedMessage {
  factory WireMessageQuery({
    ...
    if (queryCapabilities != null) {
      $result.queryCapabilities = queryCapabilities;
    }
    if (configureSensor != null) {
      $result.configureSensor = configureSensor;
    }
    if (liveDataPoll != null) {
      $result.liveDataPoll = liveDataPoll;
    }
    if (downloadFile != null) {
      $result.downloadFile = downloadFile;
    }
    if (eraseFile != null) {
      $result.eraseFile = eraseFile;
    }
  ...
  @$pb.TagNumber(1)
  set type(QueryType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set queryCapabilities(QueryCapabilities v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQueryCapabilities() => $_has(1);
  @$pb.TagNumber(2)
  void clearQueryCapabilities() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set configureSensor(ConfigureSensorQuery v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConfigureSensor() => $_has(2);
  @$pb.TagNumber(3)
  void clearConfigureSensor() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(8)
  set liveDataPoll(LiveDataPoll v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLiveDataPoll() => $_has(3);
  @$pb.TagNumber(8)
  void clearLiveDataPoll() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set downloadFile(DownloadFile v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDownloadFile() => $_has(4);
  @$pb.TagNumber(10)
  void clearDownloadFile() => $_clearField(10);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set eraseFile(EraseFile v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasEraseFile() => $_has(5);
  @$pb.TagNumber(11)
  void clearEraseFile() => $_clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set networkSettings(NetworkSettings v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasNetworkSettings() => $_has(6);
  @$pb.TagNumber(12)
  void clearNetworkSettings() => $_clearField(12);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set identity(Identity v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasIdentity() => $_has(7);
  @$pb.TagNumber(13)
  void clearIdentity() => $_clearField(13);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set module(QueryModule v) { $_setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasModule() => $_has(8);
  @$pb.TagNumber(14)
  void clearModule() => $_clearField(14);
  @$pb.TagNumber(14)
...
class WireMessageReply extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set type(ReplyType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  $pb.PbList<Error> get errors => $_getList(1);

  @$pb.TagNumber(3)
  Capabilities get capabilities => $_getN(2);
  @$pb.TagNumber(3)
  set capabilities(Capabilities v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set liveData(LiveData v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLiveData() => $_has(3);
  @$pb.TagNumber(6)
  void clearLiveData() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set files(Files v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set fileData(FileData v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasFileData() => $_has(5);
  @$pb.TagNumber(9)
  void clearFileData() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  NetworkSettings get networkSettings => $_getN(6);
  @$pb.TagNumber(10)
  set networkSettings(NetworkSettings v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasNetworkSettings() => $_has(6);
  @$pb.TagNumber(10)
  void clearNetworkSettings() => $_clearField(10);
  @$pb.TagNumber(10)
  NetworkSettings ensureNetworkSettings() => $_ensure(6);
  ...
  Identity get identity => $_getN(7);
  @$pb.TagNumber(11)
  set identity(Identity v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasIdentity() => $_has(7);
  @$pb.TagNumber(11)
  void clearIdentity() => $_clearField(11);
  @$pb.TagNumber(11)
  Identity ensureIdentity() => $_ensure(7);
  ...
  @$pb.TagNumber(12)
  set status(DeviceStatus v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set module(ModuleReply v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasModule() => $_has(9);
  @$pb.TagNumber(13)
  void clearModule() => $_clearField(13);
  @$pb.TagNumber(13)
...
class Schedule extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  void clearRepeated() => $_clearField(3);
  ...
  @$pb.TagNumber(5)
  void clearJitter() => $_clearField(5);

  @$pb.TagNumber(6)
  $pb.PbList<Interval> get intervals => $_getList(5);
}
...
class Schedules extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  void clearModifying() => $_clearField(1);

  @$pb.TagNumber(2)
  Schedule get readings => $_getN(1);
  @$pb.TagNumber(2)
  set readings(Schedule v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReadings() => $_has(1);
  @$pb.TagNumber(2)
  void clearReadings() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set lora(Schedule v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLora() => $_has(2);
  @$pb.TagNumber(3)
  void clearLora() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set network(Schedule v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set gps(Schedule v) { $_setField(5, v); }
  @$pb.TagNumber(5)
...
class SelfCheck extends $pb.GeneratedMessage {
  factory SelfCheck({
    $core.String? key,
    $core.int? status,
  }) {
  ...
  SelfCheck._() : super();
  factory SelfCheck.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SelfCheck.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SelfCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'fk_app'), createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SelfCheck clone() => SelfCheck()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SelfCheck copyWith(void Function(SelfCheck) updates) => super.copyWith((message) => updates(message as SelfCheck)) as SelfCheck;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SelfCheck create() => SelfCheck._();
  SelfCheck createEmptyInstance() => create();
  static $pb.PbList<SelfCheck> createRepeated() => $pb.PbList<SelfCheck>();
  @$core.pragma('dart2js:noInline')
  static SelfCheck getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SelfCheck>(create);
  static SelfCheck? _defaultInstance;
...
class HardwareStatus extends $pb.GeneratedMessage {
  factory HardwareStatus({
    $core.Iterable<SelfCheck>? selfChecks,
  }) {
    final $result = create();
    if (selfChecks != null) {
      $result.selfChecks.addAll(selfChecks);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HardwareStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'fk_app'), createEmptyInstance: create)
    ..pc<SelfCheck>(1, _omitFieldNames ? '' : 'selfChecks', $pb.PbFieldType.PM, subBuilder: SelfCheck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<SelfCheck> get selfChecks => $_getList(0);
}
...
class GpsStatus extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  void clearSatellites() => $_clearField(3);
...
class MemoryStatus extends $pb.GeneratedMessage {
  factory MemoryStatus({
    ...
    if (sramAvailable != null) {
      $result.sramAvailable = sramAvailable;
    }
    if (programFlashAvailable != null) {
      $result.programFlashAvailable = programFlashAvailable;
    }
    if (extendedMemoryAvailable != null) {
      $result.extendedMemoryAvailable = extendedMemoryAvailable;
    }
    if (dataMemoryInstalled != null) {
      $result.dataMemoryInstalled = dataMemoryInstalled;
    }
    if (dataMemoryUsed != null) {
      $result.dataMemoryUsed = dataMemoryUsed;
    }
    if (dataMemoryConsumption != null) {
      $result.dataMemoryConsumption = dataMemoryConsumption;
    }
    if (firmware != null) {
      $result.firmware.addAll(firmware);
    }
    return $result;
  }
  ...
  @$pb.TagNumber(1)
  void clearSramAvailable() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  void clearProgramFlashAvailable() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearExtendedMemoryAvailable() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearDataMemoryInstalled() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearDataMemoryUsed() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  void clearDataMemoryConsumption() => $_clearField(6);

  @$pb.TagNumber(7)
  $pb.PbList<Firmware> get firmware => $_getList(6);
}
...
class PowerStatus extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set battery(BatteryStatus v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set solar(SolarStatus v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class Status extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearUptime() => $_clearField(2);

  @$pb.TagNumber(3)
  Identity get identity => $_getN(2);
  @$pb.TagNumber(3)
  set identity(Identity v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set hardware(HardwareStatus v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set power(PowerStatus v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPower() => $_has(4);
  @$pb.TagNumber(5)
  void clearPower() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set memory(MemoryStatus v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set gps(GpsStatus v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasGps() => $_has(6);
  @$pb.TagNumber(7)
  void clearGps() => $_clearField(7);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set schedules(Schedules v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSchedules() => $_has(7);
  @$pb.TagNumber(8)
  void clearSchedules() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set recording(Recording v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasRecording() => $_has(8);
  @$pb.TagNumber(9)
  void clearRecording() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set network(NetworkSettings v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set firmware(Firmware v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasFirmware() => $_has(11);
  @$pb.TagNumber(12)
  void clearFirmware() => $_clearField(12);
  @$pb.TagNumber(12)
...
class DownloadQuery extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $pb.PbList<Range> get ranges => $_getList(1);

  @$pb.TagNumber(4)
  $pb.PbList<$core.int> get blocks => $_getList(2);
}
...
class Recording extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  void clearStartedTime() => $_clearField(3);

  @$pb.TagNumber(4)
  Location get location => $_getN(3);
  @$pb.TagNumber(4)
  set location(Location v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class LoraSettings extends $pb.GeneratedMessage {
  factory LoraSettings({
    ...
    if (frequencyBand != null) {
      $result.frequencyBand = frequencyBand;
    }
    if (deviceEui != null) {
      $result.deviceEui = deviceEui;
    }
    if (appKey != null) {
      $result.appKey = appKey;
    }
    if (joinEui != null) {
      $result.joinEui = joinEui;
    }
    if (deviceAddress != null) {
      $result.deviceAddress = deviceAddress;
    }
    if (networkSessionKey != null) {
      $result.networkSessionKey = networkSessionKey;
    }
    if (appSessionKey != null) {
      $result.appSessionKey = appSessionKey;
    }
    if (verify != null) {
  ...
  @$pb.TagNumber(2)
  void clearModifying() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearClearing() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearFrequencyBand() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearDeviceEui() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  void clearAppKey() => $_clearField(6);
  ...
  @$pb.TagNumber(7)
  void clearJoinEui() => $_clearField(7);
  ...
  @$pb.TagNumber(9)
  void clearNetworkSessionKey() => $_clearField(9);
  ...
  @$pb.TagNumber(10)
  void clearAppSessionKey() => $_clearField(10);

  @$pb.TagNumber(11)
  $core.bool get verify => $_getBF(10);
  @$pb.TagNumber(11)
  set verify($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasVerify() => $_has(10);
  @$pb.TagNumber(11)
  void clearVerify() => $_clearField(11);
}
...
class Transmission extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set wifi(WifiTransmission v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class HttpQuery extends $pb.GeneratedMessage {
  factory HttpQuery({
    ...
    if (loraSettings != null) {
      $result.loraSettings = loraSettings;
    }
    if (time != null) {
      $result.time = time;
    }
  ...
  @$pb.TagNumber(2)
  set identity(Identity v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set recording(Recording v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set schedules(Schedules v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSchedules() => $_has(3);
  @$pb.TagNumber(4)
  void clearSchedules() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set networkSettings(NetworkSettings v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set loraSettings(LoraSettings v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLoraSettings() => $_has(6);
  @$pb.TagNumber(7)
  void clearLoraSettings() => $_clearField(7);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set locate(Location v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasLocate() => $_has(8);
  @$pb.TagNumber(9)
  void clearLocate() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set transmission(Transmission v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTransmission() => $_has(9);
  @$pb.TagNumber(10)
  void clearTransmission() => $_clearField(10);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set directory(ListDirectory v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDirectory() => $_has(10);
  @$pb.TagNumber(11)
  void clearDirectory() => $_clearField(11);
  @$pb.TagNumber(11)
...
class LiveSensorReading extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set sensor(SensorCapabilities v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSensor() => $_has(0);
  @$pb.TagNumber(1)
  void clearSensor() => $_clearField(1);
  ...
  @$pb.TagNumber(4)
  void clearFactory() => $_clearField(4);
...
class LiveModuleReadings extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set module(ModuleCapabilities v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<LiveSensorReading> get readings => $_getList(1);
}
...
class LiveReadings extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $pb.PbList<LiveModuleReadings> get modules => $_getList(1);
}
...
class DirectoryEntry extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearDirectory() => $_clearField(4);
}
...
class DirectoryListing extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $pb.PbList<DirectoryEntry> get entries => $_getList(1);
...
class NearbyNetworks extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $pb.PbList<NearbyNetwork> get networks => $_getList(0);
}
...
class HttpReply extends $pb.GeneratedMessage {
  factory HttpReply({
    ...
    if (liveReadings != null) {
      $result.liveReadings.addAll(liveReadings);
    }
    if (loraSettings != null) {
      $result.loraSettings = loraSettings;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpReply', package: const $pb.PackageName(_omitMessageNames ? '' : 'fk_app'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(13, _omitFieldNames ? '' : 'events', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set status(Status v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set networkSettings(NetworkSettings v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasNetworkSettings() => $_has(3);
  @$pb.TagNumber(4)
  void clearNetworkSettings() => $_clearField(4);
  @$pb.TagNumber(4)
  NetworkSettings ensureNetworkSettings() => $_ensure(3);

  @$pb.TagNumber(5)
  $pb.PbList<ModuleCapabilities> get modules => $_getList(4);

  @$pb.TagNumber(6)
  $pb.PbList<DataStream> get streams => $_getList(5);

  @$pb.TagNumber(7)
  $pb.PbList<LiveReadings> get liveReadings => $_getList(6);

  @$pb.TagNumber(8)
  LoraSettings get loraSettings => $_getN(7);
  @$pb.TagNumber(8)
  set loraSettings(LoraSettings v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLoraSettings() => $_has(7);
  @$pb.TagNumber(8)
  void clearLoraSettings() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set schedules(Schedules v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasSchedules() => $_has(8);
  @$pb.TagNumber(9)
  void clearSchedules() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set listing(DirectoryListing v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasListing() => $_has(10);
  @$pb.TagNumber(11)
  void clearListing() => $_clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set nearbyNetworks(NearbyNetworks v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasNearbyNetworks() => $_has(11);
  @$pb.TagNumber(12)
  void clearNearbyNetworks() => $_clearField(12);
  @$pb.TagNumber(12)
  NearbyNetworks ensureNearbyNetworks() => $_ensure(11);

  @$pb.TagNumber(13)
  $core.List<$core.int> get events => $_getN(12);
  @$pb.TagNumber(13)
  set events($core.List<$core.int> v) { $_setBytes(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasEvents() => $_has(12);
  @$pb.TagNumber(13)
  void clearEvents() => $_clearField(13);
}
...
class ModuleHttpQuery extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set type(ModuleQueryType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => $_clearField(1);
...
class ModuleHttpReply extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set type(ModuleReplyType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => $_clearField(1);
...
class UdpMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set status(UdpStatus v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStatus() => $_has(1);
  @$pb.TagNumber(2)
  void clearStatus() => $_clearField(2);
