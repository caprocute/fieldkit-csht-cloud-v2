set(ARM_TOOLS "${CMAKE_SOURCE_DIR}/third-party/gcc-arm-none-eabi/bin")
...
function(enable_m0_target target_name target_board)
  ...
  set(target_c_flags "-g -Os -s -ffunction-sections -fdata-sections -fno-omit-frame-pointer -fstack-usage -nostdlib --param max-inline-insns-single=500 -MMD -mcpu=${target_mcu} -mthumb ${target_board_flags} ${ARDUINO_PROJECT_FLAGS}")
...
function(enable_m4_target target_name target_board)
  ...
  set(target_c_flags "-g -Os -s -ffunction-sections -fdata-sections -fno-omit-frame-pointer -fstack-usage -nostdlib -save-temps=obj --param max-inline-insns-single=500 -MMD -mcpu=${target_mcu} -mthumb ${target_board_flags} ${ARDUINO_PROJECT_FLAGS}")
  set(target_cxx_flags "${target_c_flags} -fno-threadsafe-statics -fno-rtti -fno-exceptions")
  set(target_asm_flags "-g -x assembler-with-cpp -mcpu=${target_mcu} -mthumb ${target_board_flags}")
