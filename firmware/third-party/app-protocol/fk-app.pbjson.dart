...
@$core.Deprecated('Use selfCheckDescriptor instead')
...
/// Descriptor for `SelfCheck`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List selfCheckDescriptor = $convert.base64Decode(
    'CglTZWxmQ2hlY2sSEAoDa2V5GAEgASgJUgNrZXkSFgoGc3RhdHVzGAIgASgNUgZzdGF0dXM=');

@$core.Deprecated('Use hardwareStatusDescriptor instead')
const HardwareStatus$json = {
  '1': 'HardwareStatus',
  '2': [
    {'1': 'self_checks', '3': 1, '4': 3, '5': 11, '6': '.fk_app.SelfCheck', '10': 'selfChecks'},
  ],
};
...
final $typed_data.Uint8List hardwareStatusDescriptor = $convert.base64Decode(
    'Cg5IYXJkd2FyZVN0YXR1cxIyCgtzZWxmX2NoZWNrcxgBIAMoCzIRLmZrX2FwcC5TZWxmQ2hlY2'
    'tSCnNlbGZDaGVja3M=');
...
const LoraSettings$json = {
  ...
  '2': [
    ...
    {'1': 'verify', '3': 11, '4': 1, '5': 8, '10': 'verify'},
...
final $typed_data.Uint8List loraSettingsDescriptor = $convert.base64Decode(
    ...
    '5nGAIgASgIUgltb2RpZnlpbmcSGgoIY2xlYXJpbmcYAyABKAhSCGNsZWFyaW5nEhYKBnZlcmlm'
    'eRgLIAEoCFIGdmVyaWZ5EiQKDWZyZXF1ZW5jeUJhbmQYBCABKA1SDWZyZXF1ZW5jeUJhbmQSHA'
    'oJZGV2aWNlRXVpGAUgASgMUglkZXZpY2VFdWkSFgoGYXBwS2V5GAYgASgMUgZhcHBLZXkSGAoH'
    'am9pbkV1aRgHIAEoDFIHam9pbkV1aRIkCg1kZXZpY2VBZGRyZXNzGAggASgMUg1kZXZpY2VBZG'
    'RyZXNzEiwKEW5ldHdvcmtTZXNzaW9uS2V5GAkgASgMUhFuZXR3b3JrU2Vzc2lvbktleRIkCg1h'
    'cHBTZXNzaW9uS2V5GAogASgMUg1hcHBTZXNzaW9uS2V5');
...
const HttpReply$json = {
  ...
  '2': [
    ...
    {'1': 'events', '3': 13, '4': 1, '5': 12, '10': 'events'},
  ],
};
...
final $typed_data.Uint8List httpReplyDescriptor = $convert.base64Decode(
    ...
    'lOZXR3b3Jrc1IObmVhcmJ5TmV0d29ya3MSFgoGZXZlbnRzGA0gASgMUgZldmVudHM=');
