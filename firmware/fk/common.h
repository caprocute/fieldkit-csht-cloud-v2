...
#define FK_PRIORITY_SCHEDULER_TASK (FK_PRIORITY_NORMAL + 0)

#define FK_PRIORITY_DISPLAY_TASK (FK_PRIORITY_NORMAL)

#define FK_PRIORITY_NETWORK_TASK (FK_PRIORITY_NORMAL)

#define FK_PRIORITY_BUTTONS (FK_PRIORITY_NORMAL)

#define FK_PRIORITY_TOPOLOGY_PIN (FK_PRIORITY_NORMAL)

#define FK_PRIORITY_READINGS_TASK (FK_PRIORITY_NORMAL + 0)

#define FK_PRIORITY_NETWORK_HANDLER_TASK (FK_PRIORITY_NORMAL + 1)

#define FK_PRIORITY_NETWORK_M2M_TASK (FK_PRIORITY_NETWORK_TASK + 2)
