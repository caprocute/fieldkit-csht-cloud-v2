...
static FlashGeometry ToshibaGeometry{ ToshibaPageSize,       ToshibaBlockSize,
                                      ToshibaNumberOfBlocks, ToshibaNumberOfBlocks *ToshibaBlockSize,
                                      ToshibaProgramSize,    ToshibaPagesPerBlock,
                                      ToshibaPageSize };
...
static FlashGeometry KoxiaGeometry{ OriginalPageSize, KoxiaBlockSize,     KoxiaNumberOfBlocks, KoxiaNumberOfBlocks *KoxiaBlockSize,
                                    KoxiaProgramSize, KoxiaPagesPerBlock, KoxiaPageSize };
...
static FlashGeometry AllianceGeometry{ AlliancePageSize,       AllianceBlockSize,
                                       AllianceNumberOfBlocks, AllianceNumberOfBlocks *AllianceBlockSize,
                                       AllianceProgramSize,    AlliancePagesPerBlock,
                                       AlliancePageSize };
...
bool SpiFlash::begin() {
    ...
    if (model_ == ChipModel::Unknown) {
        uint8_t read_jedec_addressed[2] = { CMD_READ_JEDEC_ID, 0x00 };
