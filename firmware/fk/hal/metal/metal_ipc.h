...
public:
    ...
    bool dequeue_activity(Activity **ptr, uint32_t to) override;
    bool enqueue_button_down(Button *ptr) override;
    bool enqueue_button_up(Button *ptr) override;
    bool dequeue_button(Button **ptr, uint32_t to) override;
