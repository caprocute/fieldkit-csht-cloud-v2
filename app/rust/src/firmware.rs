...
pub async fn cache_firmware(
    ...
    trace!(%background, "cache_firwmare");
...
async fn publish_available_firmware(
    ...
    trace!("publish_available_firmware");
