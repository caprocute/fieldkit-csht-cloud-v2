...
class Loggers {
  ...
  static Logger _stations = devNull;
  ...
  static void initialize(String logsPath) {
    ...
    _stations = create(fileOutput, "stations", colors);
    _path = path;
  ...
  static Logger get stations => _stations;
...
class Backup {
  ...
  Future<String?> create() async {
    try {
      ...
      Loggers.main.i("backup: $zipPath $zipFile $length");
      return zipPath;
    } catch (e) {
