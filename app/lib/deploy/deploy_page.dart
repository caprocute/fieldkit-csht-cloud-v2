            ...
            ElevatedTextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  final String location = values["location"] as String;
                  ...
                  try {
                    ...
                    messenger.showSnackBar(SnackBar(
                      content: Text(localizations.stationDeployed),
                    ));
                  } catch (e) {
                    Loggers.ui.e("Deploy error: $e");
                    messenger.showSnackBar(SnackBar(
...
extension ScheduleHelpers on Schedule_Every {
  static Schedule_Every fromForm(FormValues values) {
    final int every = int.parse(values["scheduleEvery"] as String);
    final UnitOfTime unit = values["scheduleUnit"] as UnitOfTime;
    return ScheduleHelpers.from(every, unit);
  }

  static Schedule_Every from(int every, UnitOfTime unit) {
    switch (unit) {
