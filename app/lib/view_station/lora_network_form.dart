          ...
          ElevatedTextButton(
            onPressed: () async {
              if (_formKey.currentState!.saveAndValidate()) {
                ...
                final LoraBand band = values["band"] as LoraBand;
                final String appKey = values["appKey"] as String;
                final String joinEui = values["joinEui"] as String;
                Loggers.ui.i("$values");
...
FormFieldValidator<String?> hexString({
  String? errorText,
}) {
