...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 84003392;
...
abstract class RustLibApi extends BaseApi {
  Future<int?> crateApiAddOrUpdateStationInPortal(
      {required Tokens tokens, required AddOrUpdatePortalStation station});

  Future<Authenticated> crateApiAuthenticatePortal(
      {required String email, required String password});

  Future<FirmwareDownloadStatus> crateApiCacheFirmware(
      {Tokens? tokens, required bool background});

  Future<void> crateApiCalibrate(
      {required String deviceId,
      required BigInt module,
      required List<int> data});

  Future<void> crateApiCheckForArchives();

  Future<void> crateApiClearCalibration(
      {required String deviceId, required BigInt module});

  Future<void> crateApiConfigureDeploy(
      {required String deviceId, required DeployConfig config});

  Future<void> crateApiConfigureLoraTransmission(
      {required String deviceId, required LoraTransmissionConfig config});

  Future<void> crateApiConfigureName(
      {required String deviceId, required NameConfig config});

  Future<void> crateApiConfigureSchedule(
      {required String deviceId, required ScheduleConfig config});

  Future<void> crateApiConfigureWifiNetworks(
      {required String deviceId, required WifiNetworksConfig config});

  Future<void> crateApiConfigureWifiTransmission(
      {required String deviceId, required WifiTransmissionConfig config});

  Stream<String> crateApiCreateLogSink();

  Future<List<StationConfig>> crateApiForgetStation({required String deviceId});

  Future<List<StationConfig>> crateApiGetMyStations();

  Future<Registered> crateApiRegisterPortalAccount(
      {required String email,
      required String password,
      required String name,
      required bool tncAccount});

  Future<bool> crateApiRustReleaseMode();

  Future<void> crateApiSetStationBusy(
      {required String deviceId, required bool busy});

  Future<TransferProgress> crateApiStartDownload(
      {required String deviceId, BigInt? first, required BigInt total});

  Stream<DomainMessage> crateApiStartNative(
      {required String storagePath, required String portalBaseUrl});

  Future<TransferProgress> crateApiStartUpload(
      {required String deviceId,
      required Tokens tokens,
      required List<RecordArchive> files});

  Future<UpgradeProgress> crateApiUpgradeStation(
      {required String deviceId,
      required LocalFirmware firmware,
      required bool swap});

  Future<Authenticated> crateApiValidateTokens({required Tokens tokens});

  Future<void> crateApiVerifyLoraTransmission({required String deviceId});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<int?> crateApiAddOrUpdateStationInPortal(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiAddOrUpdateStationInPortalConstMeta,
      argValues: [tokens, station],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAddOrUpdateStationInPortalConstMeta =>
      const TaskConstMeta(
  ...
  Future<Authenticated> crateApiAuthenticatePortal(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiAuthenticatePortalConstMeta,
      argValues: [email, password],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAuthenticatePortalConstMeta => const TaskConstMeta(
  ...
  Future<FirmwareDownloadStatus> crateApiCacheFirmware(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCacheFirmwareConstMeta,
      argValues: [tokens, background],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCacheFirmwareConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiCalibrate(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCalibrateConstMeta,
      argValues: [deviceId, module, data],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCalibrateConstMeta => const TaskConstMeta(
        debugName: "calibrate",
  ...
  Future<void> crateApiCheckForArchives() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCheckForArchivesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCheckForArchivesConstMeta => const TaskConstMeta(
        debugName: "check_for_archives",
        argNames: [],
      );
  ...
  Future<void> crateApiClearCalibration(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiClearCalibrationConstMeta,
      argValues: [deviceId, module],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiClearCalibrationConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiConfigureDeploy(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiConfigureDeployConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureDeployConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiConfigureLoraTransmission(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiConfigureLoraTransmissionConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureLoraTransmissionConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiConfigureName(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiConfigureNameConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureNameConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiConfigureSchedule(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(deviceId, serializer);
        sse_encode_box_autoadd_schedule_config(config, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiConfigureScheduleConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureScheduleConstMeta => const TaskConstMeta(
        debugName: "configure_schedule",
        argNames: ["deviceId", "config"],
      );
  ...
  Future<void> crateApiConfigureWifiNetworks(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiConfigureWifiNetworksConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureWifiNetworksConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiConfigureWifiTransmission(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiConfigureWifiTransmissionConstMeta,
      argValues: [deviceId, config],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigureWifiTransmissionConstMeta =>
      const TaskConstMeta(
  ...
  Stream<String> crateApiCreateLogSink() {
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCreateLogSinkConstMeta,
      argValues: [sink],
      apiImpl: this,
    )));
    return sink.stream;
  ...
  TaskConstMeta get kCrateApiCreateLogSinkConstMeta => const TaskConstMeta(
        debugName: "create_log_sink",
        argNames: ["sink"],
      );

  @override
  Future<List<StationConfig>> crateApiForgetStation(
      {required String deviceId}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
      ...
      constMeta: kCrateApiForgetStationConstMeta,
      argValues: [deviceId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiForgetStationConstMeta => const TaskConstMeta(
        debugName: "forget_station",
        argNames: ["deviceId"],
      );
  ...
  Future<List<StationConfig>> crateApiGetMyStations() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiGetMyStationsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiGetMyStationsConstMeta => const TaskConstMeta(
  ...
  Future<Registered> crateApiRegisterPortalAccount(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRegisterPortalAccountConstMeta,
      argValues: [email, password, name, tncAccount],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRegisterPortalAccountConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiRustReleaseMode() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustReleaseModeConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRustReleaseModeConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiSetStationBusy(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSetStationBusyConstMeta,
      argValues: [deviceId, busy],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSetStationBusyConstMeta => const TaskConstMeta(
        debugName: "set_station_busy",
        argNames: ["deviceId", "busy"],
      );
  ...
  Future<TransferProgress> crateApiStartDownload(
    ...
    return handler.executeNormal(NormalTask(
      ...
      argValues: [deviceId, first, total],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiStartDownloadConstMeta => const TaskConstMeta(
        ...
        argNames: ["deviceId", "first", "total"],
      );

  @override
  Stream<DomainMessage> crateApiStartNative(
      {required String storagePath, required String portalBaseUrl}) {
    final sink = RustStreamSink<DomainMessage>();
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(storagePath, serializer);
        sse_encode_String(portalBaseUrl, serializer);
        sse_encode_StreamSink_domain_message_Sse(sink, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiStartNativeConstMeta,
      argValues: [storagePath, portalBaseUrl, sink],
      apiImpl: this,
    )));
    return sink.stream;
  }

  TaskConstMeta get kCrateApiStartNativeConstMeta => const TaskConstMeta(
        debugName: "start_native",
        argNames: ["storagePath", "portalBaseUrl", "sink"],
      );
  ...
  Future<TransferProgress> crateApiStartUpload(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStartUploadConstMeta,
      argValues: [deviceId, tokens, files],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStartUploadConstMeta => const TaskConstMeta(
  ...
  Future<UpgradeProgress> crateApiUpgradeStation(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUpgradeStationConstMeta,
      argValues: [deviceId, firmware, swap],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUpgradeStationConstMeta => const TaskConstMeta(
  ...
  Future<Authenticated> crateApiValidateTokens({required Tokens tokens}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiValidateTokensConstMeta,
      argValues: [tokens],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiValidateTokensConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiVerifyLoraTransmission({required String deviceId}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiVerifyLoraTransmissionConstMeta,
      argValues: [deviceId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiVerifyLoraTransmissionConstMeta =>
      const TaskConstMeta(
  ...
  @protected
  RustStreamSink<DomainMessage> dco_decode_StreamSink_domain_message_Sse(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError();
  }
  ...
  @protected
  ScheduleConfig dco_decode_box_autoadd_schedule_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_schedule_config(raw);
  }

  @protected
  SchedulesConfig dco_decode_box_autoadd_schedules_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_schedules_config(raw);
  }
  ...
  DeployConfig dco_decode_deploy_config(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return DeployConfig(
      location: dco_decode_opt_String(arr[0]),
      deployed: dco_decode_opt_box_autoadd_u_64(arr[1]),
  ...
  DomainMessage dco_decode_domain_message(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return const DomainMessage_PreAccount();
      case 1:
  ...
  DownloadProgress dco_decode_download_progress(dynamic raw) {
    ...
    return DownloadProgress(
      ...
      first: dco_decode_opt_box_autoadd_usize(arr[2]),
      total: dco_decode_usize(arr[3]),
      received: dco_decode_usize(arr[4]),
    );
  }
  ...
  EphemeralConfig dco_decode_ephemeral_config(dynamic raw) {
    ...
    return EphemeralConfig(
      ...
      deployment: dco_decode_opt_box_autoadd_deployment_config(arr[2]),
      transmission: dco_decode_opt_box_autoadd_transmission_config(arr[3]),
      networks: dco_decode_list_network_config(arr[4]),
      schedules: dco_decode_opt_box_autoadd_schedules_config(arr[5]),
      lora: dco_decode_opt_box_autoadd_lora_config(arr[6]),
      capabilities: dco_decode_device_capabilities(arr[7]),
      events: dco_decode_list_prim_u_8_strict(arr[8]),
    );
  }
  ...
  FirmwareDownloadStatus dco_decode_firmware_download_status(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return const FirmwareDownloadStatus_Checking();
      case 1:
        return FirmwareDownloadStatus_Downloading(
          dco_decode_box_autoadd_download_progress(raw[1]),
        );
      case 2:
        return const FirmwareDownloadStatus_Offline();
      case 3:
        return const FirmwareDownloadStatus_Completed();
      case 4:
        return const FirmwareDownloadStatus_Failed();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  ScheduleConfig? dco_decode_opt_box_autoadd_schedule_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_schedule_config(raw);
  }

  @protected
  SchedulesConfig? dco_decode_opt_box_autoadd_schedules_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_schedules_config(raw);
  }
  ...
  PortalError dco_decode_portal_error(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return const PortalError_Authentication();
      case 1:
        return const PortalError_Connecting();
      case 2:
        return PortalError_Other(
          dco_decode_String(raw[1]),
        );
      case 3:
        return const PortalError_Sdk();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  ScheduleConfig dco_decode_schedule_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return ScheduleConfig(
      schedule: dco_decode_schedule(arr[0]),
    );
  }

  @protected
  SchedulesConfig dco_decode_schedules_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return SchedulesConfig(
      readings: dco_decode_opt_box_autoadd_schedule_config(arr[0]),
    );
  }
  ...
  TransferStatus dco_decode_transfer_status(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 2:
        return const TransferStatus_Processing();
      case 3:
        return const TransferStatus_Completed();
      case 4:
        return const TransferStatus_Failed();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  UpgradeStatus dco_decode_upgrade_status(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return const UpgradeStatus_Starting();
      case 1:
        return UpgradeStatus_Uploading(
          dco_decode_box_autoadd_upload_progress(raw[1]),
        );
      case 2:
        return const UpgradeStatus_Restarting();
      case 3:
        return const UpgradeStatus_ReconnectTimeout();
      case 4:
        return const UpgradeStatus_Completed();
      case 5:
  ...
  UploadProgress dco_decode_upload_progress(dynamic raw) {
    ...
    return UploadProgress(
      ...
      readingsUploaded: dco_decode_u_64(arr[2]),
      totalReadings: dco_decode_u_64(arr[3]),
    );
  }
  ...
  @protected
  RustStreamSink<DomainMessage> sse_decode_StreamSink_domain_message_Sse(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    throw UnimplementedError('Unreachable ()');
  }
  ...
  @protected
  ScheduleConfig sse_decode_box_autoadd_schedule_config(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_schedule_config(deserializer));
  }

  @protected
  SchedulesConfig sse_decode_box_autoadd_schedules_config(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_schedules_config(deserializer));
  }
  ...
  DeployConfig sse_decode_deploy_config(SseDeserializer deserializer) {
    ...
    var var_deployed = sse_decode_opt_box_autoadd_u_64(deserializer);
  ...
  DownloadProgress sse_decode_download_progress(SseDeserializer deserializer) {
    ...
    var var_first = sse_decode_opt_box_autoadd_usize(deserializer);
  ...
  EphemeralConfig sse_decode_ephemeral_config(SseDeserializer deserializer) {
    ...
    var var_schedules =
        sse_decode_opt_box_autoadd_schedules_config(deserializer);
  ...
  @protected
  ScheduleConfig? sse_decode_opt_box_autoadd_schedule_config(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_schedule_config(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  SchedulesConfig? sse_decode_opt_box_autoadd_schedules_config(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_schedules_config(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  ScheduleConfig sse_decode_schedule_config(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_schedule = sse_decode_schedule(deserializer);
    return ScheduleConfig(schedule: var_schedule);
  }

  @protected
  SchedulesConfig sse_decode_schedules_config(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_readings = sse_decode_opt_box_autoadd_schedule_config(deserializer);
    return SchedulesConfig(readings: var_readings);
  }
  ...
  UploadProgress sse_decode_upload_progress(SseDeserializer deserializer) {
    ...
    var var_readingsUploaded = sse_decode_u_64(deserializer);
    var var_totalReadings = sse_decode_u_64(deserializer);
    return UploadProgress(
        bytesUploaded: var_bytesUploaded,
        totalBytes: var_totalBytes,
        readingsUploaded: var_readingsUploaded,
        totalReadings: var_totalReadings);
  }
  ...
  @protected
  void sse_encode_StreamSink_domain_message_Sse(
      RustStreamSink<DomainMessage> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(
        self.setupAndSerialize(
            codec: SseCodec(
  ...
  @protected
  void sse_encode_box_autoadd_schedule_config(
      ScheduleConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_schedule_config(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_schedules_config(
      SchedulesConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_schedules_config(self, serializer);
  }
  ...
  void sse_encode_deploy_config(DeployConfig self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_u_64(self.deployed, serializer);
  ...
  void sse_encode_download_progress(
    ...
    sse_encode_opt_box_autoadd_usize(self.first, serializer);
  ...
  void sse_encode_ephemeral_config(
    ...
    sse_encode_opt_box_autoadd_schedules_config(self.schedules, serializer);
  ...
  @protected
  void sse_encode_opt_box_autoadd_schedule_config(
      ScheduleConfig? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_schedule_config(self, serializer);
    }
  }

  @protected
  void sse_encode_opt_box_autoadd_schedules_config(
      SchedulesConfig? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_schedules_config(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_schedule_config(
      ScheduleConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_schedule(self.schedule, serializer);
  }
  ...
  @protected
  void sse_encode_schedules_config(
      SchedulesConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_opt_box_autoadd_schedule_config(self.readings, serializer);
  }
  ...
  void sse_encode_upload_progress(
    ...
    sse_encode_u_64(self.readingsUploaded, serializer);
    sse_encode_u_64(self.totalReadings, serializer);
  }
