...
// These functions are ignored because they are not marked as `pub`: `add_or_update_station_in_portal`, `authenticate_portal`, `background_task`, `cache_firmware`, `calibrate`, `check_for_archives`, `clear_calibration`, `configure`, `create_sdk`, `decoded`, `file_name`, `forget_station`, `from_reply`, `from`, `get_my_stations`, `get_nearby_addr`, `handle_background_message`, `new`, `new`, `new`, `open`, `refresh_token`, `refresh_tokens`, `register_portal_account`, `run`, `set_station_busy`, `start_download`, `start_runtime`, `start_upload`, `upgrade_station`, `validate_tokens`, `verify_lora_transmission`, `with_runtime`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `LogSink`, `MergeAndPublishReplies`, `RuntimeError`, `SdkMappingError`, `Sdk`, `StationAndConnection`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `flush`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `from`, `from`, `from`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `into`, `make_writer`, `try_into`, `write`
...
Future<void> configureSchedule(
    ...
    RustLib.instance.api
        .crateApiConfigureSchedule(deviceId: deviceId, config: config);
...
Future<List<StationConfig>> forgetStation({required String deviceId}) =>
    RustLib.instance.api.crateApiForgetStation(deviceId: deviceId);

Future<TransferProgress> startDownload(
        {required String deviceId, BigInt? first, required BigInt total}) =>
    RustLib.instance.api
        .crateApiStartDownload(deviceId: deviceId, first: first, total: total);
...
Future<void> setStationBusy({required String deviceId, required bool busy}) =>
    RustLib.instance.api.crateApiSetStationBusy(deviceId: deviceId, busy: busy);

Future<void> checkForArchives() =>
    RustLib.instance.api.crateApiCheckForArchives();
...
class EphemeralConfig {
  ...
  final SchedulesConfig? schedules;
...
class SchedulesConfig {
  ...
  @override
  int get hashCode => readings.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SchedulesConfig &&
          runtimeType == other.runtimeType &&
...
class UploadProgress {
  ...
  final BigInt readingsUploaded;
  final BigInt totalReadings;

  const UploadProgress({
    required this.bytesUploaded,
    required this.totalBytes,
    required this.readingsUploaded,
  ...
  bool operator ==(Object other) =>
      ...
      other is UploadProgress &&
          ...
          readingsUploaded == other.readingsUploaded &&
