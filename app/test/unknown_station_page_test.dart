...
void main() {
  group('NoSuchStationPage', () {
    testWidgets('displays correct localized texts',
      ...
      // Build our app and trigger a frame with custom ThemeData.
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            useMaterial3: true,
            splashFactory: InkSplash.splashFactory, // Use InkSplash to avoid InkSparkle issues
          ),
          localizationsDelegates: const [AppLocalizations.delegate],
          home: const NoSuchStationPage(),
        ),
      );
