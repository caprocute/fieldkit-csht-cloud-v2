...
typedef enum _fk_data_EventSystem {
    ...
    fk_data_EventSystem_EVENT_SYSTEM_USER = 7
} fk_data_EventSystem;
...
typedef struct _fk_data_SensorAndValue {
    ...
    union _fk_data_SensorAndValue_calibrated {
        float calibratedValue;
        bool calibratedNull;
    } calibrated;
    pb_size_t which_uncalibrated;
    union _fk_data_SensorAndValue_uncalibrated {
...
#define _fk_data_EventSystem_MAX fk_data_EventSystem_EVENT_SYSTEM_USER
#define _fk_data_EventSystem_ARRAYSIZE ((fk_data_EventSystem)(fk_data_EventSystem_EVENT_SYSTEM_USER+1))
...
#define fk_data_Event_system_ENUMTYPE fk_data_EventSystem
#define fk_data_Event_severity_ENUMTYPE fk_data_Severity


#define fk_data_SignedRecord_kind_ENUMTYPE fk_data_SignedRecordKind




#define fk_data_Calibration_type_ENUMTYPE fk_data_CurveType
...
#define fk_data_SensorAndValue_init_default      {0, 0, {0}, 0, {0}, 0}
...
#define fk_data_Status_init_default              {0, 0, 0, 0, 0, 0}
...
#define fk_data_SensorAndValue_init_zero         {0, 0, {0}, 0, {0}, 0}
...
#define fk_data_Status_init_zero                 {0, 0, 0, 0, 0, 0}
...
#define fk_data_SensorAndValue_has_calibration_tag 6
...
#define fk_data_Status_wifiEnabled_tag           6
...
X(a, STATIC,   SINGULAR, BOOL,     has_calibration,   6)
...
X(a, STATIC,   SINGULAR, UINT64,   wifiEnabled,       6)
