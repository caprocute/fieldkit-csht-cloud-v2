...
(function(global, factory) { /* global define, require, module */
    ...
    $root.fk_data = (function() {
        ...
        fk_data.SensorAndValue = (function() {
             ...
             * @property {boolean|null} [hasCalibration] SensorAndValue hasCalibration
            ...
            /**
             * SensorAndValue hasCalibration.
             * @member {boolean} hasCalibration
             * @memberof fk_data.SensorAndValue
             * @instance
             */
            SensorAndValue.prototype.hasCalibration = false;
            ...
            SensorAndValue.encode = function encode(message, writer) {
                ...
                if (message.hasCalibration != null && message.hasOwnProperty("hasCalibration"))
                    writer.uint32(/* id 6, wireType 0 =*/48).bool(message.hasCalibration);
                return writer;
            };
            ...
            SensorAndValue.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1:
                        ...
                        break;
                    case 6:
                        message.hasCalibration = reader.bool();
                        break;
                    case 4:
            ...
            SensorAndValue.verify = function verify(message) {
                ...
                if (message.sensor != null && message.hasOwnProperty("sensor"))
                    if (!$util.isInteger(message.sensor))
                        return "sensor: integer expected";
                if (message.hasCalibration != null && message.hasOwnProperty("hasCalibration"))
                    if (typeof message.hasCalibration !== "boolean")
                        return "hasCalibration: boolean expected";
                if (message.calibratedNull != null && message.hasOwnProperty("calibratedNull")) {
            ...
            SensorAndValue.fromObject = function fromObject(object) {
                ...
                if (object.sensor != null)
                    message.sensor = object.sensor >>> 0;
                if (object.hasCalibration != null)
                    message.hasCalibration = Boolean(object.hasCalibration);
            ...
            SensorAndValue.toObject = function toObject(message, options) {
                ...
                if (message.hasCalibration != null && message.hasOwnProperty("hasCalibration"))
                    object.hasCalibration = message.hasCalibration;
                return object;
            };
        ...
        fk_data.Status = (function() {
             ...
             * @property {number|Long|null} [wifiEnabled] Status wifiEnabled
             */
            ...
            /**
             * Status wifiEnabled.
             * @member {number|Long} wifiEnabled
             * @memberof fk_data.Status
             * @instance
             */
            Status.prototype.wifiEnabled = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
            ...
            Status.encode = function encode(message, writer) {
                ...
                if (message.wifiEnabled != null && message.hasOwnProperty("wifiEnabled"))
                    writer.uint32(/* id 6, wireType 0 =*/48).uint64(message.wifiEnabled);
                return writer;
            };
            ...
            Status.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        message.wifiEnabled = reader.uint64();
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            Status.verify = function verify(message) {
                ...
                if (message.wifiEnabled != null && message.hasOwnProperty("wifiEnabled"))
                    if (!$util.isInteger(message.wifiEnabled) && !(message.wifiEnabled && $util.isInteger(message.wifiEnabled.low) && $util.isInteger(message.wifiEnabled.high)))
                        return "wifiEnabled: integer|Long expected";
                return null;
            };
            ...
            Status.fromObject = function fromObject(object) {
                ...
                if (object.wifiEnabled != null)
                    if ($util.Long)
                        (message.wifiEnabled = $util.Long.fromValue(object.wifiEnabled)).unsigned = true;
                    else if (typeof object.wifiEnabled === "string")
                        message.wifiEnabled = parseInt(object.wifiEnabled, 10);
                    else if (typeof object.wifiEnabled === "number")
                        message.wifiEnabled = object.wifiEnabled;
                    else if (typeof object.wifiEnabled === "object")
                        message.wifiEnabled = new $util.LongBits(object.wifiEnabled.low >>> 0, object.wifiEnabled.high >>> 0).toNumber(true);
                return message;
            };
            ...
            Status.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, true);
                        object.wifiEnabled = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.wifiEnabled = options.longs === String ? "0" : 0;
                }
                if (message.time != null && message.hasOwnProperty("time"))
                    if (typeof message.time === "number")
                        object.time = options.longs === String ? String(message.time) : message.time;
                ...
                if (message.wifiEnabled != null && message.hasOwnProperty("wifiEnabled"))
                    if (typeof message.wifiEnabled === "number")
                        object.wifiEnabled = options.longs === String ? String(message.wifiEnabled) : message.wifiEnabled;
                    else
                        object.wifiEnabled = options.longs === String ? $util.Long.prototype.toString.call(message.wifiEnabled) : options.longs === Number ? new $util.LongBits(message.wifiEnabled.low >>> 0, message.wifiEnabled.high >>> 0).toNumber(true) : message.wifiEnabled;
                return object;
            };
         ...
         * @property {number} EVENT_SYSTEM_USER=7 EVENT_SYSTEM_USER value
         */
        fk_data.EventSystem = (function() {
            ...
            values[valuesById[7] = "EVENT_SYSTEM_USER"] = 7;
            return values;
        })();
