...
func (h *noopRecordHandler) OnMeta(ctx context.Context, provision *data.Provision, rawMeta *pb.DataRecord, db *data.MetaRecord) error {
	return nil
}

func (h *noopRecordHandler) OnData(ctx context.Context, provision *data.Provision, rawData *pb.DataRecord, rawMeta *pb.DataRecord, db *data.DataRecord, meta *data.MetaRecord) error {
	return nil
}
...
func (h *muxRecordHandler) OnMeta(ctx context.Context, provision *data.Provision, rawMeta *pb.DataRecord, db *data.MetaRecord) error {
	for _, h := range h.handlers {
		if err := h.OnMeta(ctx, provision, rawMeta, db); err != nil {
			return err
		}
	}
	return nil
...
func (h *muxRecordHandler) OnData(ctx context.Context, provision *data.Provision, rawData *pb.DataRecord, rawMeta *pb.DataRecord, db *data.DataRecord, meta *data.MetaRecord) error {
	for _, h := range h.handlers {
