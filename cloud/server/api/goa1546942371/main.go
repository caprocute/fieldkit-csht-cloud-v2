...
import (
	...
	_ "gitlab.com/fieldkit/cloud/server/api/design"
...
func main() {
	...
	if err := os.RemoveAll("gen/admin"); err != nil {
		fail(err.Error())
	}
	...
	if err := os.RemoveAll("gen/data_events"); err != nil {
		fail(err.Error())
	}
	...
	if err := os.RemoveAll("gen/station_note"); err != nil {
		fail(err.Error())
	}
	...
	if err := os.RemoveAll("gen/notifications"); err != nil {
		fail(err.Error())
	}
	if err := os.RemoveAll("gen/moderation"); err != nil {
		fail(err.Error())
	}
