...
// NewAcceptTncRequestBody builds the HTTP request body from the payload of the
// "accept tnc" endpoint of the "user" service.
...
// NewResumeResultNoContent builds a "user" service "resume" endpoint result
...
// NewResumeUnauthorized builds a user service resume endpoint unauthorized
// error.
...
// NewAcceptTncUserOK builds a "user" service "accept tnc" endpoint result from
// a HTTP "OK" response.
...
// NewAcceptTncUnauthorized builds a user service accept tnc endpoint
// unauthorized error.
...
// NewAcceptTncForbidden builds a user service accept tnc endpoint forbidden
// error.
...
// NewAcceptTncNotFound builds a user service accept tnc endpoint not-found
// error.
...
// NewAcceptTncBadRequest builds a user service accept tnc endpoint bad-request
// error.
...
// NewDeleteAccountUnauthorized builds a user service delete account endpoint
// unauthorized error.
func NewDeleteAccountUnauthorized(body *DeleteAccountUnauthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewDeleteAccountForbidden builds a user service delete account endpoint
// forbidden error.
func NewDeleteAccountForbidden(body *DeleteAccountForbiddenResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewDeleteAccountNotFound builds a user service delete account endpoint
// not-found error.
func NewDeleteAccountNotFound(body *DeleteAccountNotFoundResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewDeleteAccountBadRequest builds a user service delete account endpoint
// bad-request error.
func NewDeleteAccountBadRequest(body *DeleteAccountBadRequestResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// resume_not-found_response_body
...
// resume_bad-request_response_body
...
// ValidateAcceptTncUnauthorizedResponseBody runs the validations defined on
// accept tnc_unauthorized_response_body
...
// ValidateAcceptTncForbiddenResponseBody runs the validations defined on
// accept tnc_forbidden_response_body
...
// ValidateAcceptTncNotFoundResponseBody runs the validations defined on accept
// tnc_not-found_response_body
...
// ValidateAcceptTncBadRequestResponseBody runs the validations defined on
// accept tnc_bad-request_response_body
...
// ValidateDeleteAccountUnauthorizedResponseBody runs the validations defined
// on delete account_unauthorized_response_body
func ValidateDeleteAccountUnauthorizedResponseBody(body *DeleteAccountUnauthorizedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateDeleteAccountForbiddenResponseBody runs the validations defined on
// delete account_forbidden_response_body
func ValidateDeleteAccountForbiddenResponseBody(body *DeleteAccountForbiddenResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateDeleteAccountNotFoundResponseBody runs the validations defined on
// delete account_not-found_response_body
func ValidateDeleteAccountNotFoundResponseBody(body *DeleteAccountNotFoundResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateDeleteAccountBadRequestResponseBody runs the validations defined on
// delete account_bad-request_response_body
func ValidateDeleteAccountBadRequestResponseBody(body *DeleteAccountBadRequestResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
func ValidateUserResponseBody(body *UserResponseBody) (err error) {
	...
	if body.TncDate == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("tncDate", "body"))
	}
	if body.Name != nil {
