...
// Five returns an endpoint that makes HTTP requests to the tasks service five
// server.
func (c *Client) Five() goa.Endpoint {
	var (
		decodeResponse = DecodeFiveResponse(c.decoder, c.RestoreResponseBody)
	)
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		req, err := c.BuildFiveRequest(ctx, v)
		if err != nil {
			return nil, err
		}
		resp, err := c.FiveDoer.Do(req)
		if err != nil {
