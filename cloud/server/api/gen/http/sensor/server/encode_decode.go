...
// EncodeStationMetaResponse returns an encoder for responses returned by the
// sensor station meta endpoint.
...
// DecodeStationMetaRequest returns a decoder for requests sent to the sensor
...
// EncodeStationMetaError returns an encoder for errors returned by the station
// meta sensor endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewStationMetaUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewStationMetaForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewStationMetaNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewStationMetaBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeSensorMetaResponse returns an encoder for responses returned by the
// sensor sensor meta endpoint.
...
// EncodeSensorMetaError returns an encoder for errors returned by the sensor
// meta sensor endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewSensorMetaUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewSensorMetaForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewSensorMetaNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewSensorMetaBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeTailResponse returns an encoder for responses returned by the sensor
// tail endpoint.
...
// DecodeTailRequest returns a decoder for requests sent to the sensor tail
// endpoint.
...
// EncodeTailError returns an encoder for errors returned by the tail sensor
// endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewTailUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewTailForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewTailNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewTailBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeRecentlyResponse returns an encoder for responses returned by the
// sensor recently endpoint.
...
// DecodeRecentlyRequest returns a decoder for requests sent to the sensor
// recently endpoint.
...
// EncodeRecentlyError returns an encoder for errors returned by the recently
// sensor endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewRecentlyUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewRecentlyForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewRecentlyNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewRecentlyBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
