...
// EncodeAcceptProjectInviteResponse returns an encoder for responses returned
// by the project accept project invite endpoint.
...
// DecodeAcceptProjectInviteRequest returns a decoder for requests sent to the
// project accept project invite endpoint.
func DecodeAcceptProjectInviteRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		payload := NewAcceptProjectInvitePayload(projectID, auth)
		if strings.Contains(payload.Auth, " ") {
			// Remove authorization scheme prefix (e.g. "Bearer")
			cred := strings.SplitN(payload.Auth, " ", 2)[1]
			payload.Auth = cred
...
// EncodeAcceptProjectInviteError returns an encoder for errors returned by the
// accept project invite project endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewAcceptProjectInviteUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewAcceptProjectInviteForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewAcceptProjectInviteNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewAcceptProjectInviteBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeRejectProjectInviteResponse returns an encoder for responses returned
// by the project reject project invite endpoint.
...
// DecodeRejectProjectInviteRequest returns a decoder for requests sent to the
// project reject project invite endpoint.
func DecodeRejectProjectInviteRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		payload := NewRejectProjectInvitePayload(projectID, auth)
		if strings.Contains(payload.Auth, " ") {
			// Remove authorization scheme prefix (e.g. "Bearer")
			cred := strings.SplitN(payload.Auth, " ", 2)[1]
			payload.Auth = cred
...
// EncodeRejectProjectInviteError returns an encoder for errors returned by the
// reject project invite project endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewRejectProjectInviteUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewRejectProjectInviteForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewRejectProjectInviteNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewRejectProjectInviteBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeEditUserResponse returns an encoder for responses returned by the
// project edit user endpoint.
...
// DecodeEditUserRequest returns a decoder for requests sent to the project
// edit user endpoint.
func DecodeEditUserRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		err = ValidateEditUserRequestBody(&body)
		if err != nil {
			return nil, err
		}
		...
		payload := NewEditUserPayload(&body, projectID, auth)
		if strings.Contains(payload.Auth, " ") {
			// Remove authorization scheme prefix (e.g. "Bearer")
			cred := strings.SplitN(payload.Auth, " ", 2)[1]
			payload.Auth = cred
...
// EncodeEditUserError returns an encoder for errors returned by the edit user
// project endpoint.
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewEditUserUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewEditUserForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "not-found":
			...
			if formatter != nil {
				...
				body = NewEditUserNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not-found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "bad-request":
			...
			if formatter != nil {
				...
				body = NewEditUserBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad-request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
func EncodeDownloadPhotoResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*projectviews.DownloadedPhoto)
		enc := encoder(ctx, w)
...
func DecodeDownloadPhotoRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		payload := NewDownloadPhotoPayload(projectID, size, ifNoneMatch, auth)
		if payload.Auth != nil {
			if strings.Contains(*payload.Auth, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.Auth, " ", 2)[1]
