...
```
postgresql://fieldkit:WxdI7USgPlkSVOcrE8cCcn2vA@fieldkit-staging-postgres-nlb-2e92e35ac371a189.elb.ap-southeast-1.amazonaws.com:5432/fieldkit?sslmode=disable
```
...
```bash
curl -X POST 'http://fieldkit-staging-alb-1189893191.ap-southeast-1.elb.amazonaws.com/login' \
